...
void XrayTelDetectorConstruction::ConstructTelescope()
{
  ...
  G4VSolid* SphereSolid1 = new G4Sphere("SphereSolid",rmin,rmax,Sphere1SPhi,Sphere1DPhi,Sphere1STheta,Sphere1DTheta);
  G4LogicalVolume* SphereLogical1 = new G4LogicalVolume(SphereSolid1,Al,"SphereLogical");
  new G4PVPlacement(0,G4ThreeVector(0.*cm,0.*cm,0.*cm),"SpherePhysical",SphereLogical1,physicalWorld,false,0);
  ...
  G4VSolid* SphereSolid2 = new G4Sphere("SphereSolid",rmin,rmax,Sphere2SPhi,Sphere2DPhi,Sphere2STheta,Sphere2DTheta);
  G4LogicalVolume* SphereLogical2 = new G4LogicalVolume(SphereSolid2,Al,"SphereLogical");
  new G4PVPlacement(0,G4ThreeVector(200.*cm,0.*cm,0.*cm),"SpherePhysical",SphereLogical2,physicalWorld,false,0);
  ...
  for (i=0;i<part;i++){
      ...
      SphereSolid3[i] = new G4Sphere("SphereSolid",rmin,rmax,Sphere3SPhi,Sphere3DPhi,Sphere3STheta,Sphere3DTheta);
      SphereLogical3[i] = new G4LogicalVolume(SphereSolid3[i],Al,"SphereLogical");
      new G4PVPlacement(0,G4ThreeVector(400.*cm,0.*cm,0.*cm),"SpherePhysical",SphereLogical3[i],physicalWorld,false,0);
  }




  //new G4LogicalSkinSurface("TargetIrSurface",SphereLogical3[l],xray_surface_property);
